...
# pobrac film_id, title, desc, rating, rental_rate, rental_date, payment_date, payment_amount
...
with Session() as session:
    ...
    result = list(result_proxy.mappings())
...
wb.save(filename='office_doc/film.xlsx')
