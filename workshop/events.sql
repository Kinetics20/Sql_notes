...
CREATE EVENT deactivate_old_customers
    ...
    BEGIN
        ...
        WHERE ren.return_date IS NULL OR ren.rental_date < NOW() - INTERVAL  20 YEAR
    );
    END //
...
# codzienna archiwizja starych platnosci
...
DELIMITER //
    ...
    CREATE EVENT archive_old_payment
        ...
        STARTS TIMESTAMP(CURRENT_DATE + INTERVAL 1 DAY, '20:00:00')
        DO
        BEGIN
            INSERT INTO payment_archive
            SELECT *
            FROM payment
            WHERE payment.payment_date < NOW() -INTERVAL  2 YEAR;
